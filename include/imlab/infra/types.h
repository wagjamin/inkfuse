...
class Integer {
   ...
   static imlab::schemac::Type getBackingType() {
       return imlab::schemac::Type::Integer();
   }
...
class Varchar {
   ...
   char value[kMaxLen];
    ...
    static constexpr imlab::schemac::Type getBackingType() {
        return imlab::schemac::Type::Varchar(kMaxLen);
    }
...
class Char {
   ...
   char value[kMaxLen];
    ...
    static imlab::schemac::Type getBackingType() {
        return imlab::schemac::Type::Char(kMaxLen);
    }
...
class Numeric {
   ...
   friend class Numeric;
    ...
    static imlab::schemac::Type getBackingType() {
        return imlab::schemac::Type::Numeric(len, precision);
    }
...
class Date {
   ...
   int32_t value;
    ...
    static imlab::schemac::Type getBackingType() {
        return imlab::schemac::Type::Timestamp();
    }
